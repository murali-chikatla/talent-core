...
@Setter
@Builder
@Schema(description = "Standard error response returned by the core service")
public class ErrorResponse {
    ...
    @Schema(description = "Safe business error message", example = "Employee ID already exists")
